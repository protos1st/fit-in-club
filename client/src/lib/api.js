...
export const api = {
  ...
  passProfile: (userId) => request('/api/moderation/pass', { method: 'POST', body: { userId } }),
  unpassProfile: (userId) => request(`/api/moderation/pass/${userId}`, { method: 'DELETE' }),
  getPassed: () => request('/api/moderation/passed'),
